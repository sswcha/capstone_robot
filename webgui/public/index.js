...
window.addEventListener("load", function(){ //when page loads
 ...
 //   document.addEventListener("touchmove", ReportTouchMove, false);
    ...
    document.addEventListener("keydown", ReportKeyDown, false);
    document.addEventListener("keyup", ReportKeyUp, false)
...
function ReportKeyDown(e) {
  ...
  if (arrowPressed == false) {
    ...
    switch (key) {
      case "ArrowUp":
	socket.emit('msg','{"ArrowUp":1}');
	document.getElementById("DebugData").innerHTML = '{"ArrowUp":1}';
	break;
      case "ArrowDown":
	socket.emit('msg','{"ArrowDown":1}');
	document.getElementById("DebugData").innerHTML = '{"ArrowDown":1}';
	break;
      case "ArrowLeft":
	socket.emit('msg','{"ArrowLeft":1}');
	document.getElementById("DebugData").innerHTML = '{"ArrowLeft":1}';
	break;
      case "ArrowRight":
	socket.emit('msg','{"ArrowRight":1}');
	document.getElementById("DebugData").innerHTML = '{"ArrowRight":1}';
	break;
      default:
      arrowPresssed = false;
	break;
